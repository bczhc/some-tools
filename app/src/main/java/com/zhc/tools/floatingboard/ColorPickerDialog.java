...
class ColorPickerDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WindowManager manager = Objects.requireNonNull(getWindow()).getWindowManager();

        int height = (int) (manager.getDefaultDisplay().getHeight() * .5);       //0.5

        int width = (int) (manager.getDefaultDisplay().getWidth() * .7);          //0.7
...
/*
---------------------
        版权声明：本文为CSDN博主「by2n」的原创文章，遵循CC 4.0 by-sa版权协议，转载请附上原文出处链接及本声明。
        原文链接：https://blog.csdn.net/by317966834/article/details/8781052*/
