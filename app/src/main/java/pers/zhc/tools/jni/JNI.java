...
public class JNI {
    ...
    public static class CharUcd {
        public interface OrdinaryCallback {
            /**
             * the ordinary that is in processing
             *
             * @param i ordinary
             */
            void progress(int i);
         ...
         *
         * @param src  XML path
         * @param dest intermediate file path
         * @param f    progress callback
         */
        public static native void parseXml(String src, String dest, OrdinaryCallback f);

        /**
         * parse the intermediate file generated by {@link CharUcd#parseXml(String, String, ProgressCallback)} and write to SQLite3 database
         *
         * @param src  intermediate file path
         * @param dest SQLite3 database output path
         * @param f    progress callback
         */
        public static native void writeDatabase(String src, String dest, OrdinaryCallback f);
